...
def get_stock_price_max_profit_with_transaction_limit(prices: List[int], max_transactions=2) -> int:
    """
    Time Complexity: O(n)
...
print(get_stock_price_max_profit_with_transaction_limit_pulled_from_example([6, 1, 3, 2, 4, 7], 2))
