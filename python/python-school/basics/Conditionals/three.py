...
print('''
So {0}
'''.format('it\'s a draw. 1 Point for each' if inpScores[0] == inpScores[1] else '{0} won. 3 Points for them in the standings'.format(inpTeams[0] if inpScores[0] > inpScores[1] else inpTeams[1]))) 
