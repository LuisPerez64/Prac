...
print('You got a(n) {0} which is a(n) {1} . {2}'.format(round(curGrade/60,2), letterGrade[ind], 'Wow. Can\'t really get better than that can we. Congratulations.' if ind == 0 else 'We can always strive for a little bit more can\'t we. You\'d need {0} points to boost your score to a(n) {1}'.format(gradesList[ind-1]-curGrade, letterGrade[ind-1])))    
