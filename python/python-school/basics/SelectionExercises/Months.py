...
for k in seasons:
    if month in seasons[k]:
        ...
        print('This month has {0} days'.format( 30 if month in days30 else 29 if (month in daysLeap  and isLeapYear) else 28 if (month in daysLeap and not isLeapYear) else 31))
